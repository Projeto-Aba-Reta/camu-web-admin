# gatilhos-de-migracao-juridica

## Purpose

Manter um painel com os 4 gatilhos fixos que indicam a necessidade de migração jurídica de MEI para ME, com status e histórico de mudanças, restrito a Owner e Sócio.
