# Spec: Configurações do Sistema

## Purpose

TBD - Define a tela de configurações globais (parâmetros chave/valor) do
painel administrativo, restrita ao Owner, e a auditoria de suas alterações.
