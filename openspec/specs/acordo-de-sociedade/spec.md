...
Manter um registro versionado e histórico da regra de divisão de lucro vigente entre os sócios e das condições de saída de sócio, restrito a Owner e Sócio.
