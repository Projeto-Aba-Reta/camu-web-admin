# acompanhamento-de-faturamento-x-teto

## Purpose

Permitir o acompanhamento mensal do faturamento acumulado da MEI/ME em relação ao teto anual configurável, calculando o percentual do teto já atingido para apoiar a decisão de migração jurídica.
