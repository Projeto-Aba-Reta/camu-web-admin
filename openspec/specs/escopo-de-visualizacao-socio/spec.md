# Spec: Escopo de Visualização do Sócio

## Purpose

Define as regras de escopo de visualização da sidebar para usuários com `user_type = 'socio'`, incluindo o controle de alternância "ver todas as áreas" e seu comportamento em relação a sessão e permissões de dados.
