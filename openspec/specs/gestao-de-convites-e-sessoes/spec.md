# Spec: Gestão de Convites e Sessões

## Purpose

TBD - Define a tela de Convites & Sessões, restrita ao Owner, cobrindo a
listagem de convites pendentes, reenvio/cancelamento de convites e revogação
de sessões ativas de usuários.
