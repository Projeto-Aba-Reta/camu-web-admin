...
TBD - Define o comportamento do painel administrativo (`/admin`), landing da
seção Administração, incluindo suas métricas resumidas e atalhos de navegação
para as demais subseções administrativas.
