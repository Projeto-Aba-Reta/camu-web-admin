# Spec: Tela de Acordo de Sociedade

## Purpose

Define o comportamento da tela de acordo de sociedade, que exibe e permite atualizar a regra de divisão de lucro e as condições de saída vigentes, com histórico versionado, além da listagem e registro de contribuições de capital por sócio.
