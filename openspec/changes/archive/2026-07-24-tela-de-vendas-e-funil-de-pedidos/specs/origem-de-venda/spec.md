...
O sistema SHALL exigir o preenchimento do vendedor responsável — um perfil de usuário do sistema — ao cadastrar ou editar um pedido cuja origem esteja marcada como exigindo vendedor, e SHALL aceitar vendedor responsável em branco nas demais origens.
